...
A tool to work with Carbon files (called `karbonit-tool`) is shipped with this library.
...
The tool supports the POSIX standard for its arguments. Type `bin/karbonit-tool` for usage instructions.
