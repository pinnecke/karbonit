...
json_t *jansson_json_object(void)
{
...
json_t *jansson_json_array(void)
{
...
json_t *jansson_json_string(const char *value)
{
    if(!value)
        return NULL;
