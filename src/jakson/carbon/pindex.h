...
bool pindex_it_field_type(carbon_field_type_e *type, pindex_it *it);
...
bool pindex_it_field_binary_value(carbon_binary *out, carbon_array *it);
bool pindex_it_field_array_value(carbon_array *it_out, pindex_it *it_in);
